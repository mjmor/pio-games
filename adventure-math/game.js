...
function preload() {
    ...
    game.load.image('3', 'assets/numbers/three.png');
    game.load.image('4', 'assets/numbers/four.png');
    game.load.image('5', 'assets/numbers/five.png');
    game.load.image('6', 'assets/numbers/six.png');
    game.load.image('7', 'assets/numbers/seven.png');
    ...
    game.load.image('restart_button', 'assets/restart_button_khmer.png');
...
function collectStar(player, star) {
  // In order to collect a star, the player must answer a math
  // question correctly.
  problemSolvedCb = function () {
